...
// StockPickingType (Sorting type determines the sorting view)
type StockPickingType struct {
	...
	WareHouse  *StockWarehouse   `orm:"rel(fk)"`                            
	NextStep   *StockPickingType `orm:"null;rel(one)"`                        
	PrevStep   *StockPickingType `orm:"null;rel(one)"`                        
	IsStart    bool              `orm:"default(false)"`                      
	IsEnd      bool              `orm:"default(false)"`                       
