...
type ProductSupplier struct {
	...
	Supplier        *Partner         `orm:"rel(fk)"`                              
	ProductName     string           `json:"ProductName"`                         
	ProductCode     string           `json:"ProductCode"`                         
	FirstMinQty     float32          `orm:"default(1)"`                          
	SecondMinQty    float32          `orm:"default(1)"`                           
	FirstPrice      float64          `orm:"default(0)"`                           
	SecondPrice     float64          `orm:"default(0)"`                           
	DateStart       time.Time        `orm:"type(datetime)"`                       
	DateEnd         time.Time        `orm:"type(datetime)"`                       
	DelayHour       int32            `json:"DelayHour"`                           
