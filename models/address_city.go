...
type AddressCity struct {
	...
	Province   *AddressProvince   `orm:"rel(fk)"`                              
	Districts  []*AddressDistrict `orm:"reverse(many)" json:"districts"`       

	FormAction   string   `orm:"-" json:"FormAction"`   //Non-database field, used to indicate the increase of records, modify
	ActionFields []string `orm:"-" json:"ActionFields"` //Fields that need to be manipulated for update
