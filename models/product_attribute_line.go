...
// ProductAttributeLine (product attributes details)
type ProductAttributeLine struct {
	...
	Attribute       *ProductAttribute        `orm:"rel(fk)"`                              
	ProductTemplate *ProductTemplate         `orm:"rel(fk)"`                              
	AttributeValues []*ProductAttributeValue `orm:"rel(m2m)"`                             

	FormAction        string   `orm:"-" json:"FormAction"`    
	ActionFields      []string `orm:"-" json:"ActionFields"`      
	AttributeID       int64    `orm:"-" json:"AttributeId"`       
	AttributeValueIds []int64  `orm:"-" json:"AttributeValueIds"` 
}
