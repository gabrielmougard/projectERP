...
type SaleOrderState struct {
	...
	NextStep         *SaleOrderState `orm:"null;rel(one)"`                        
	PrevStep         *SaleOrderState `orm:"null;rel(one)"`                      
	Sequence         int64           `orm:"default(1)" json:"Sequence"`     
...
// GetSaleOrderStateByCompanyStock  
